<?php
session_start();
require_once __DIR__ . '/../lib/php/conexion.php'; // Ajusta la ruta si es necesario
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item px-3 active"><a class="nav-link" href="/lib/pagina/lista_productos_srv.php"><i class="fas fa-box-open"></i> Productos</a></li>
        <li class="nav-item px-3"><a class="nav-link" href="/lib/pagina/listapedidos.php"><i class="fas fa-shopping-cart"></i> Pedidos</a></li>
    ...
    <?php else: ?>
      <?php foreach ($productos as $producto): ?>
        <div class="product-card">
          <img src="<?= htmlspecialchars($producto['imagen_url']) ?: 'https://via.placeholder.com/100' ?>" alt="<?= htmlspecialchars($producto['nombre']) ?>" class="product-image" />
          ...
          <div class="product-actions">
            <a href="/lib/pagina/editar_producto.php?id=<?= $producto['id'] ?>" title="Editar producto">
              <i class="fas fa-edit"></i>
            </a>
            <a href="/srv/eliminar_producto_srv.php?id=<?= $producto['id'] ?>" title="Eliminar producto" onclick="return confirm('¿Seguro que quieres eliminar este producto?');">
