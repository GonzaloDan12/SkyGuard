...
<head>
  <meta charset="UTF-8" />
  <title>Editar Producto - SkyGuard Admin</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item px-3"><a class="nav-link" href="#"><i class="fas fa-shopping-cart"></i> Pedidos</a></li>
  ...
  <div class="container-form">
    <a href="lista_productos.php" class="btn-back"><i class="fas fa-arrow-left"></i> Regresar a lista de productos</a>
    <h2 class="title">Editar Producto</h2>

    <form method="POST" action="/srv/editar_producto_srv.php" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <img src="<?= htmlspecialchars($producto['imagen_url'] ?: 'https://via.placeholder.com/150') ?>" alt="Imagen actual" style="max-width: 150px; height: auto;" />
      </div>
      ...
      <div class="btn-group-center">
        ...
        <a href="lista_productos.php" class="btn btn-cancel">Cancelar</a>
      </div>
    </form>
  </div>
